...
//https://us-central1-bizrec-dev.cloudfunctions.net/getRulesFunction?uid=HJIOFS#53345DD&page=0&size=10
//no body {}
  ...
  esClient.ping({ requestTimeout: 30000 }, function(error)
		{
			if (error) {
				...
				helper.failure(res, msgConfig.support_contact, 500);
			} else {
      ...
      if(error)
      {
       ...
       esClient.search(queryBodyCheckUserExists)
             ...
             helper.failure(res,msgConfig.rules_user_not_found + msgConfig.support_contact,500);
               ...
               var queryBody = {
                 ...
                 body: {
                   ...
                   size: Number(sizeVal),
                   sort: [
                        { [config.rules_record_updated_column_name]: { order: 'desc' } }
                      ]
                  }
               };
        ...
        //index dosen't exist. Create one.
         console.log('Rules Index does not Exists!. Error Value = '+JSON.stringify(err));
