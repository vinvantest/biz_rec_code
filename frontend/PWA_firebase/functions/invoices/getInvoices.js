...
//https://us-central1-bizrec-dev.cloudfunctions.net/getInvoicesFunction?uid=HJIOFS#53345DD&page=0&size=10
//no body {}
      ...
      if(error)
      {
       ...
       esClient.search(queryBodyCheckUserExists)
         .then(function (respUserCheck) {
           ...
           if(respUserCheck.hits.total === 0){
             ...
             helper.failure(res,msgConfig.invoices_user_not_found + msgConfig.support_contact,500);
               ...
               //User Uid exists
               // GET coa Data fron invoices Index
               var indexAliasName = routingUid+config.invoices_alias_token_read;
               //indexAliasName = 'invoices_index_v1';
               ...
               var queryBody = {
                 ...
                 body: {
                   ...
                   size: Number(sizeVal),
                   sort: [
                        { [config.invoices_record_updated_column_name]: { order: 'desc' } }
                      ]
                  }
               };
               ...
               .then(function (resp) {
                   ...
                   helper.success(res,resp.hits);
                     ...
                     function (error) {
                       console.log('Error : invoices document read ['+indexAliasName+'] Failed!' + JSON.stringify(error));
        ...
        //index dosen't exist. Create one.
         console.log('Invoice Index does not Exists!. Error Value = '+JSON.stringify(err));
