...
function handleGET (req, res)
{
  // Do something with the GET request
   ...
   console.log('req.query.customersId = ' + JSON.stringify(req.query.customersId));
   var routingUid = req.query.uid;
   var customersId = req.query.customersId;
   ...
   if(customersId === null || customersId === undefined) {
    resMsg = "Error: req.query.customersId required to create Index in ES ->" + customersId;
    failure(res,resMsg,401);
   }
	 ...
	 esClient.indices.exists(config.customers_index_name)
        ...
        esClient.get(queryBody)
          .then(function (resp) {
                ...
                esClient.get(queryBody)
                .then(function (resp) {
                    resMsg = 'customers Data Indexed Successfully!' ;
                    console.log(resMsg);
