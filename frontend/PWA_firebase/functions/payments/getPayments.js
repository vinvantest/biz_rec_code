...
//https://us-central1-bizrec-dev.cloudfunctions.net/getpaymentsFunction?uid=HJIOFS#53345DD&page=0&size=10
//no body {}
      ...
      if(error)
      {
       ...
       esClient.search(queryBodyCheckUserExists)
         .then(function (respUserCheck) {
           ...
           if(respUserCheck.hits.total === 0){
             ...
             helper.failure(res,msgConfig.payments_user_not_found + msgConfig.support_contact,500);
               ...
               //User Uid exists
               // GET coa Data fron payments Index
               var indexAliasName = routingUid+config.payments_alias_token_read;
               //indexAliasName = 'payments_index_v1';
               ...
               var queryBody = {
                 ...
                 body: {
                   ...
                   size: Number(sizeVal),
                   sort: [
                        { [config.payments_record_updated_column_name]: { order: 'desc' } }
                      ]
                  }
               };
               ...
               .then(function (resp) {
                   ...
                   helper.success(res,resp.hits);
                     ...
                     function (error) {
                       console.log('Error : payments document read ['+indexAliasName+'] Failed!' + JSON.stringify(error));
        ...
        //index dosen't exist. Create one.
         console.log('Payments Index does not Exists!. Error Value = '+JSON.stringify(err));
